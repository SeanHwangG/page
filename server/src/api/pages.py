            ...
            for post in h3:
                ...
                while i < len(post["ps"]):
                    ...
                    if "(edit)" in post["ps"][i]:
                        ...
                        id = id_match.group(2)
                        add_solution = tag in ["BJ", "BJE"] and id in solved
...
if __name__ == '__main__':
    ...
    with open(f"{PAGE_PATH}/data/python.json", 'r') as f:
        pages = json.load(f)
    pages = hide_unsolved(pages["posts"]["Algorithm"], ['2839'])
    with open(f"{PAGE_PATH}/data/python3.json", 'w') as f:
